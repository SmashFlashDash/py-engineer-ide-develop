...
class RLCI(Device):
    ...
    uv_di = {
        ...
        'on imMOD': lambda: executeTMI(doEquation('10.01.FIP_INFO', '@K', 'cele') + " and " +
                                       ...
                                       doEquation('10.01.FIP_M778B_INF', '@K', 'off'), count=10, period=5),
...
def FKP_RLCI_DR():
    ...
    di = ["{04.02.VBAEA%s}@K==[25,35]" % RLCI.EA332.cur,
          "{04.02.CBAEA%s}@K==[0.5, 1.24]" % RLCI.EA332.cur,
...
def TEST_15(num=1):
    ...
    BCK.downBCK()
    di = ["{04.02.VBAEA%s}@K==[25,35]" % RLCI.EA332.cur,
          "{04.02.CBAEA%s}@K==[0.5, 0.9]" % RLCI.EA332.cur,
          "{04.02.VKKEA%s}@K==[25,35]" % RLCI.EA331.cur,
    ...
    BCK.downBCK()
    di = ["{04.02.VBAEA%s}@K==[25,35]" % RLCI.EA332.cur,
          "{04.02.CBAEA%s}@K==[0.5, 1.7]" % RLCI.EA332.cur,
          "{04.02.VKKEA%s}@K==[25,35]" % RLCI.EA331.cur,
          "{04.02.CKKEA%s}@K==[0.01, 1.5]" % RLCI.EA331.cur]
    executeTMI(" and ".join(di))
    ...
    BCK.downBCK()
    di = ["{04.02.VBAEA%s}@K==[25,35]" % RLCI.EA332.cur,
          "{04.02.CBAEA%s}@K==[0.5, 2.0]" % RLCI.EA332.cur,
          "{04.02.VKKEA%s}@K==[25,35]" % RLCI.EA331.cur,
